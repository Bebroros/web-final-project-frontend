    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const total = subsRes.data.reduce((acc, sub) => {
                    ...
                    <Card sx={{
                        ...
                        <CardActions sx={{ p: 2, pt: 0 }}>
                            <Button
                                ...
                                sx={{ borderRadius: 2, py: 1,color: '#1a252f'}}
                            >
                                Open Calendar
                            </Button>
                        </CardActions>
                    ...
                    <Card sx={{
                        ...
                        <CardActions sx={{ p: 2, pt: 0 }}>
                            <Button
                                ...
                                color="success"
                                endIcon={<ArrowForwardIcon />}
                                sx={{ borderRadius: 2, py: 1,  color: '#003304' }}
                            >
                                Manage Budget
                            </Button>
                        </CardActions>
                        ...
                        <CardActions sx={{ p: 2, pt: 0 }}>
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    color: '#ebdff8',
                                    fontWeight: 'bold',
                                    '&:hover': { bgcolor: '#490078' } // Ще темніший при наведенні
                                }}
                            >
                                Get Prediction
                            </Button>
